...
export class LoginComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    function coverEyes() {
      TweenMax.to(armL, .45, { x: -93, y: 2, rotation: 0, ease: Power1.easeOut });
      TweenMax.to(armR, .45, { x: -93, y: 2, rotation: 0, ease: Power1.easeOut, delay: .1 });
    }
    function uncoverEyes() {
      TweenMax.to(armL, 1.35, { y: 220, ease: Power1.easeOut });
      TweenMax.to(armL, 1.35, { rotation: 105, ease: Power1.easeOut, delay: .1 });
      TweenMax.to(armR, 1.35, { y: 220, ease: Power1.easeOut });
      TweenMax.to(armR, 1.35, { rotation: -105, ease: Power1.easeOut, delay: .1 });
    }
    function resetFace() {
